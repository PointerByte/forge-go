...
#
# `share/component/wit/world.wit` is the contract. `share/component/tinygo/wit/world.wit` is the
...
if ! diff -u \
  ...
  echo "the TinyGo build world has drifted from share/component/wit/world.wit" >&2
  exit 1
fi
