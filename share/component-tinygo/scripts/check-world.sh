#!/usr/bin/env bash
# Proves the comparison world exports exactly the production `operations` interface.
#
...
if ! diff -u \
  ...
  echo "the comparison world has drifted from share/component/wit/world.wit" >&2
  exit 1
fi
