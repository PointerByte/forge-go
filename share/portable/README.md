...
That promotion now exists as the sibling `share/component/` module, which owns the WIT
...
`build.sh` produces a deterministic release bundle under `share/component/artifacts/`
