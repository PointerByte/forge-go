...
Esa promoción existe ahora como el módulo hermano `share/component/`, que posee el
...
`share/component/artifacts/` (ignorado por git): el componente validado, su WIT
